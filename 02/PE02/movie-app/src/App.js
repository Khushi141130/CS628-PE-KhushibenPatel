...
const App = () => {
  ...
  const initialMovies = [
    ...
    { id: 4, title: "Dhurandhar The Revange", genre: " Action/Adventure", releaseYear: 2026 },
    { id: 5, title: "Mahavatar Narsimha", genre: "Animated, Mythological, Action, Devotional", releaseYear: 2025 },
    { id: 6, title: "12th Fail", genre: "Drama", releaseYear: 2023 },
  ];
